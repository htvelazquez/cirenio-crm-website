...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="/es">Cirenio <i>CRM</i></a>
                ...
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            ...
                            <p>Ahorra tiempo automatizando tu proceso con una interfaz intuitiva y fácil de utilizar.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                ...
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            ...
                            <p>Utiliza nuestras herramientas de forma gratuita sin suscripción por un periodo de 7 días.</p>
                        </div>
                    </div>
                </div>
            </div>
